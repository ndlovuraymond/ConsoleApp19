            ...
            { Console.WriteLine("1. New game \n" + "2. About the Author \n" + "3. Exit");
                ...
                { case "1":
                        ...
                        do
                        {
                            ...
                            if (A == B && B == C && C == D && D == E && E == F && F == G && G == H && H == I && D != " ")
                            { Console.WriteLine("Tie!"); break; }
                                                        
                        } while (J < 10);
                        do { Console.Write("Press any key to return to the main menu.");
                            Console.ReadKey();
                            Console.Clear();
                        } while (J == 9);
                        continue;
                        
                  case "2": Console.Write("Raymond Ndlovu is a 21 year old Computer Science Student at WSB Poznan. \n" 
                      + "(Press any key to return to Menu)");
                        Console.ReadKey();
                        Console.Clear();
                        break; 
                  case "3": Console.WriteLine("Are you sure you want to quit? [y/n]");
                        Console.Write(">  ");
